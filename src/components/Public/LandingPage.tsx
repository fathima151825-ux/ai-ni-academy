    ...
    <div className="min-h-screen bg-[#0b0f1a]">
        ...
        <div className="max-w-[1380px] mx-auto px-6 sm:px-8 lg:px-12 py-6">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              className="px-8 py-3 text-sm font-bold text-white bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] rounded-lg hover:from-[#ff0a2a] hover:to-[#ff1e3c] transition-all duration-300 shadow-lg shadow-[#ff1e3c]/30 hover:shadow-[#ff1e3c]/50 hover:scale-105"
            >
              Register Now
            </a>
          </div>
      ...
      <section className="relative min-h-screen flex items-center px-6 sm:px-8 lg:px-12 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-96 h-96 bg-[#ff1e3c] opacity-20 rounded-full blur-[120px] animate-pulse"></div>
          ...
          <div className="absolute top-1/3 right-1/4 w-[400px] h-[400px] bg-[#ff1e3c] opacity-5 rounded-full blur-[100px] animate-float"></div>
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-r from-[#ff1e3c]/5 via-transparent to-blue-600/5"></div>

          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,30,60,0.05),transparent_50%)]"></div>

          <div className="absolute inset-0 opacity-[0.03]">
            <div className="absolute top-20 left-1/4 animate-floatSlow">
              <Brain className="w-64 h-64 text-[#ff1e3c]" />
            </div>
            ...
            <div className="absolute bottom-1/4 left-1/3 animate-floatSlow" style={{ animationDelay: '4s' }}>
              <Cpu className="w-72 h-72 text-[#ff1e3c]" />
            </div>
        ...
        <div className="max-w-[1380px] mx-auto relative w-full py-20 z-10">
          <div className="text-center mb-24">
            <div className="inline-block mb-8 animate-fadeIn">
              <span className="px-6 py-3 bg-[#ff1e3c]/10 border border-[#ff1e3c]/20 rounded-full text-[#ff1e3c] text-base font-semibold tracking-wide backdrop-blur-sm shadow-lg shadow-[#ff1e3c]/20">
            ...
            <div className="relative inline-block animate-fadeInScale" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
              <div className="absolute -inset-8 bg-gradient-to-r from-[#ff1e3c]/30 via-[#ff4d6b]/20 to-blue-600/30 blur-[60px] opacity-60 animate-textGlow"></div>
              <div className="absolute -inset-12 bg-gradient-to-r from-[#ff1e3c]/10 via-transparent to-blue-600/10 blur-[80px]"></div>
              ...
              <h2 className="relative text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-white mb-12 leading-[1.1] tracking-tight px-4">
                ...
                <span className="bg-gradient-to-r from-[#ff1e3c] via-[#ff4d6b] to-[#ff1e3c] bg-clip-text text-transparent animate-gradient drop-shadow-[0_0_40px_rgba(255,30,60,0.5)]">
                  Future of AI
                </span>
              </h2>
            </div>
            ...
            <div className="flex flex-col items-center gap-6 mt-16 animate-fadeInScale" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
              <div className="relative">
                <div className="absolute -inset-4 bg-gradient-to-r from-[#ff1e3c] via-[#ff0a2a] to-[#ff1e3c] blur-2xl opacity-40 animate-pulse"></div>
                <a
                  href={whatsappLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative inline-flex items-center gap-5 bg-gradient-to-r from-[#ff1e3c] via-[#ff0a2a] to-[#ff1e3c] hover:from-[#ff0a2a] hover:via-[#ff1e3c] hover:to-[#ff0a2a] text-white px-16 py-8 rounded-2xl text-2xl font-black uppercase tracking-wide transition-all duration-500 transform hover:scale-110 overflow-hidden animate-pulseGlow bg-[length:200%_100%] animate-gradient shadow-2xl shadow-[#ff1e3c]/50"
                >
          ...
          <div className="relative mt-32 group animate-fadeInScale" style={{ animationDelay: '0.8s', animationFillMode: 'both' }}>
            <div className="absolute -inset-1 bg-gradient-to-r from-[#ff1e3c] to-blue-600 rounded-3xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
            <div className="absolute -inset-2 bg-gradient-to-r from-[#ff1e3c]/20 via-blue-600/20 to-[#ff1e3c]/20 rounded-3xl blur-2xl opacity-20"></div>
            <div className="relative bg-gradient-to-br from-[#1a1f2e] to-[#0f1419] rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-[#ff1e3c]/10">
              <div className="aspect-video flex items-center justify-center p-16 bg-gradient-to-br from-[#ff1e3c]/5 to-blue-600/5 relative overflow-hidden">
                <div className="absolute inset-0 overflow-hidden opacity-10">
                  <div className="absolute top-10 left-10 animate-float">
                    <Network className="w-24 h-24 text-[#ff1e3c]" />
                  </div>
                  <div className="absolute top-20 right-20 animate-float" style={{ animationDelay: '1s' }}>
                    <Cpu className="w-32 h-32 text-blue-500" />
                  </div>
                  <div className="absolute bottom-20 left-1/4 animate-float" style={{ animationDelay: '2s' }}>
                    <Brain className="w-28 h-28 text-[#ff1e3c]" />
                  </div>
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-float" style={{ animationDelay: '0.5s' }}>
                    <Layers className="w-36 h-36 text-[#ff1e3c]/50" />
                  </div>
                </div>
                <div className="text-center relative z-10">
                  <div className="relative inline-block mb-8">
                    <div className="absolute inset-0 bg-[#ff1e3c] blur-3xl opacity-50 animate-pulse"></div>
                    <div className="absolute -inset-4 bg-gradient-to-r from-[#ff1e3c] to-blue-600 blur-2xl opacity-30"></div>
                    <GraduationCap className="w-32 h-32 text-[#ff1e3c] mx-auto relative drop-shadow-[0_0_30px_rgba(255,30,60,0.6)]" />
                  </div>
      ...
      <section className="py-32 px-6 sm:px-8 lg:px-12 bg-[#0b0f1a] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#ff1e3c]/5 to-transparent"></div>

        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 left-10 animate-float">
            <Rocket className="w-48 h-48 text-[#ff1e3c]" />
          </div>
        ...
        <div className="max-w-[1380px] mx-auto relative">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center text-white mb-24 px-4">
            Why Choose <span className="text-[#ff1e3c]">Us?</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative bg-gradient-to-br from-[#1a1f2e] to-[#0f1419] p-10 rounded-2xl border border-white/5 hover:border-[#ff1e3c]/30 transition-all duration-300 hover:transform hover:scale-105"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-[#ff1e3c]/0 to-[#ff1e3c]/0 group-hover:from-[#ff1e3c]/5 group-hover:to-[#ff1e3c]/10 rounded-2xl transition-all duration-300"></div>
                  <div className="relative">
                    <div className="w-20 h-20 bg-gradient-to-br from-[#ff1e3c]/20 to-[#ff1e3c]/5 rounded-xl flex items-center justify-center mb-8 group-hover:shadow-lg group-hover:shadow-[#ff1e3c]/20 transition-all duration-300">
                      <Icon className="w-10 h-10 text-[#ff1e3c]" />
                    </div>
      ...
      <section className="py-32 px-6 sm:px-8 lg:px-12 bg-gradient-to-b from-[#0b0f1a] to-[#0d1117] relative overflow-hidden">
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full h-px bg-gradient-to-r from-transparent via-[#ff1e3c]/50 to-transparent"></div>

        <div className="absolute top-20 right-10 opacity-5 animate-float">
          <Brain className="w-96 h-96 text-[#ff1e3c]" />
        </div>
        ...
        <div className="max-w-[1380px] mx-auto relative z-10">
          <div className="text-center mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 px-4">
              Our <span className="text-[#ff1e3c]">Premium</span> Courses
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {courses.map((course, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative bg-gradient-to-br from-[#1a1f2e] to-[#0f1419] rounded-3xl p-12 border border-white/10 hover:border-[#ff1e3c]/30 transition-all duration-500 hover:transform hover:scale-[1.02] overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-[#ff1e3c]/0 via-[#ff1e3c]/0 to-[#ff1e3c]/0 group-hover:from-[#ff1e3c]/5 group-hover:to-[#ff1e3c]/10 rounded-3xl transition-all duration-500"></div>
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-[#ff1e3c] to-blue-600 rounded-3xl opacity-0 group-hover:opacity-20 blur transition-all duration-500"></div>

                  <div className="absolute top-0 right-0 opacity-5 group-hover:opacity-10 transition-opacity duration-500">
                    {index === 0 ? (
                      <Cpu className="w-64 h-64 text-[#ff1e3c] animate-float" />
                    ) : (
                  ...
                  <div className="relative">
                    <div className="flex items-start gap-6 mb-10">
                      <div className="w-20 h-20 bg-gradient-to-br from-[#ff1e3c] to-[#ff4d6b] rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-[#ff1e3c]/30 group-hover:shadow-[#ff1e3c]/50 transition-all duration-300">
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        {course.features.map((feature, idx) => (
                          <li key={idx} className="flex items-center gap-3 text-gray-300">
                            <div className="w-2 h-2 bg-gradient-to-r from-[#ff1e3c] to-[#ff4d6b] rounded-full shadow-lg shadow-[#ff1e3c]/50"></div>
      ...
      <section className="py-40 px-6 sm:px-8 lg:px-12 bg-[#0b0f1a] relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#ff1e3c] opacity-20 rounded-full blur-[150px]"></div>
        </div>

        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-1/4 animate-float">
            <Network className="w-72 h-72 text-[#ff1e3c]" />
          </div>
          ...
          <div className="absolute top-1/2 left-10 animate-float" style={{ animationDelay: '2s' }}>
            <Brain className="w-56 h-56 text-[#ff1e3c]" />
          </div>
        ...
        <div className="max-w-[1380px] mx-auto text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-10 px-4">
            Ready to Start Your <span className="text-[#ff1e3c]">Journey?</span>
          </h2>
          ...
          <div className="flex flex-col items-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-5 bg-gradient-to-r from-[#ff1e3c] via-[#ff0a2a] to-[#ff1e3c] hover:from-[#ff0a2a] hover:via-[#ff1e3c] hover:to-[#ff0a2a] text-white px-16 py-8 rounded-2xl text-2xl font-black uppercase tracking-wide transition-all duration-500 transform hover:scale-110 relative overflow-hidden animate-pulseGlow bg-[length:200%_100%] animate-gradient shadow-2xl shadow-[#ff1e3c]/50"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent transform -skew-x-12 translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000"></div>
              <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-all duration-300"></div>
              <Phone className="w-9 h-9 relative z-10 group-hover:rotate-12 transition-transform duration-300" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
            ...
            <div>
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center gap-3 text-gray-400 hover:text-[#ff1e3c] transition-colors group"
                >
                  <div className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center group-hover:bg-[#ff1e3c]/10 transition-colors">
            ...
            <div>
              ...
              <div className="space-y-4">
                <a
                  href="#courses"
                  className="block text-gray-400 hover:text-[#ff1e3c] transition-colors"
                >
                  Our Courses
                </a>
                <a
