...
export function RegistrationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (insertError) {
      ...
      console.error('Error submitting registration:', insertError);
    } else {
      setSubmitted(true);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-[#0b0f1a] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <a
            href="/"
            className="inline-flex items-center gap-2 text-[#ff1e3c] hover:text-[#ff4d6b] font-semibold transition-colors"
          >
    ...
    <div className="min-h-screen bg-[#0b0f1a]">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-[#ff1e3c] to-blue-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-500"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0b0f1a] border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#ff1e3c] focus:ring-1 focus:ring-[#ff1e3c] transition-all"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-[#0b0f1a] border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#ff1e3c] focus:ring-1 focus:ring-[#ff1e3c] transition-all appearance-none cursor-pointer"
                >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#ff1e3c] via-[#ff0a2a] to-[#ff1e3c] hover:from-[#ff0a2a] hover:via-[#ff1e3c] hover:to-[#ff0a2a] text-white px-8 py-4 rounded-xl text-lg font-bold transition-all duration-500 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 shadow-xl shadow-[#ff1e3c]/30 hover:shadow-[#ff1e3c]/50 bg-[length:200%_100%] animate-gradient"
              >
