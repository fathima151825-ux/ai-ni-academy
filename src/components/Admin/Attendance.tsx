    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 bg-[#0d1117] border border-white/10 rounded-lg focus:ring-2 focus:ring-[#ff1e3c] focus:border-transparent outline-none text-white disabled:opacity-50"
      ...
      {loading ? (
        <div className="bg-[#1a1f2e]/50 backdrop-blur-sm border border-white/5 rounded-xl p-12 text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#ff1e3c] mx-auto"></div>
        ...
        <div>
                            ...
                            <button
                              ...
                              className={`px-6 py-2 rounded-lg font-medium transition ${
                                status === 'Present'
                                  ...
                                  : status === 'Absent'
                                  ? 'bg-[#ff1e3c]/20 text-[#ff1e3c] ring-2 ring-[#ff1e3c]/50'
          ...
          <div className="flex justify-end">
            <button
              ...
              className="bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] hover:shadow-lg hover:shadow-[#ff1e3c]/20 text-white px-8 py-3 rounded-lg font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
