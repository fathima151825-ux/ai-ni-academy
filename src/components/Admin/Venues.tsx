...
export function Venues() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Are you sure you want to delete this venue? This will also delete all associated batches and students.')) {
      return;
    }
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {venues.map((venue) => (
            <div key={venue.id} className="bg-[#1a1f2e]/50 backdrop-blur-sm border border-white/5 rounded-xl p-6 hover:border-[#ff1e3c]/20 hover:shadow-lg hover:shadow-[#ff1e3c]/10 transition">
