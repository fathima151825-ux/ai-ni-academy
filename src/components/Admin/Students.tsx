...
export function Students() {
  ...
  const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      alert('Failed to upload photo. Photo will be optional.');
    } finally {
      setUploading(false);
    }
  };
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {students.map((student) => (
            <div key={student.id} className="bg-[#1a1f2e]/50 backdrop-blur-sm border border-white/5 rounded-xl p-6 hover:border-[#ff1e3c]/20 hover:shadow-lg hover:shadow-[#ff1e3c]/10 transition">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {student.batches && (
                    <p className="text-sm text-[#ff1e3c] mt-1">Batch: {student.batches.batch_name}</p>
                  )}
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={uploading}
                  className="flex-1 bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] hover:shadow-lg hover:shadow-[#ff1e3c]/20 text-white px-4 py-2 rounded-lg font-medium transition disabled:opacity-50"
                >
