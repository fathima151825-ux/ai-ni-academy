    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] hover:shadow-lg hover:shadow-[#ff1e3c]/20 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition"
        >
      ...
      {loading ? (
        ...
        <div className="bg-[#1a1f2e]/50 backdrop-blur-sm border border-white/5 rounded-xl p-12 text-center">
          ...
          <button
            onClick={() => setShowModal(true)}
            className="bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] hover:shadow-lg hover:shadow-[#ff1e3c]/20 text-white px-6 py-2 rounded-lg transition"
          >
            Add Staff
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {staff.map((staffMember) => (
            <div key={staffMember.id} className="bg-[#1a1f2e]/50 backdrop-blur-sm border border-white/5 rounded-xl p-6 hover:border-[#ff1e3c]/20 hover:shadow-lg hover:shadow-[#ff1e3c]/10 transition">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 bg-gradient-to-r from-[#ff1e3c]/20 to-[#ff0a2a]/20 rounded-full flex items-center justify-center flex-shrink-0">
                  <UserCircle className="w-6 h-6 text-[#ff1e3c]" />
                </div>
              ...
              <div className="flex gap-2 pt-4 border-t border-white/5">
                ...
                <button
                  ...
                  className="flex-1 bg-[#ff1e3c]/10 hover:bg-[#ff1e3c]/20 text-[#ff1e3c] px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-[#0d1117] border border-white/10 rounded-lg focus:ring-2 focus:ring-[#ff1e3c] focus:border-transparent outline-none text-white placeholder-gray-500"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-[#0d1117] border border-white/10 rounded-lg focus:ring-2 focus:ring-[#ff1e3c] focus:border-transparent outline-none text-white"
                  required
                >
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] hover:shadow-lg hover:shadow-[#ff1e3c]/20 text-white px-4 py-2 rounded-lg font-medium transition"
                >
