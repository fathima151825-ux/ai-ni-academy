...
export function Dashboard() {
  ...
  const colorClasses = {
    red: 'bg-gradient-to-r from-[#ff1e3c]/10 to-[#ff0a2a]/10 text-[#ff1e3c]',
  };
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {statCards.map((stat) => {
            ...
            return (
              <div key={stat.label} className="bg-[#1a1f2e]/50 backdrop-blur-sm border border-white/5 rounded-xl p-6 shadow-sm hover:shadow-lg hover:shadow-[#ff1e3c]/10 hover:border-[#ff1e3c]/20 transition">
