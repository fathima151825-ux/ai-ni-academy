  ...
  if (user.email !== 'admin@ainiacademy.com') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0b0f1a] via-[#0d1117] to-[#1a0d1f] flex items-center justify-center p-4">
        <div className="bg-[#1a1f2e]/50 backdrop-blur-xl border border-[#ff1e3c]/30 rounded-2xl shadow-2xl shadow-[#ff1e3c]/10 w-full max-w-md p-8 text-center">
          <div className="text-[#ff1e3c] text-6xl mb-4">⛔</div>
