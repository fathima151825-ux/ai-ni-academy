    ...
    <div className="min-h-screen bg-[#0b0f1a]">
      ...
      >
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition ${
                  currentPage === item.id
                    ? 'bg-gradient-to-r from-[#ff1e3c] to-[#ff0a2a] text-white shadow-lg shadow-[#ff1e3c]/30'
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/5">
          <button
            onClick={signOut}
            className="w-full flex items-center gap-3 px-4 py-3 text-[#ff1e3c] hover:bg-[#ff1e3c]/10 rounded-lg transition"
          >
